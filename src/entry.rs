...
pub struct EntryItem {key: String, pubType: String, tags: Vec<Tag>}
impl EntryItem {}

#[derive(Debug,PartialEq)]
pub struct StringItem {key: String, content: String}
impl StringItem {
...
fn parse_string_item_from_str() {
    ...
    assert_eq!(StringItem{key: String::from("JLW"), content: String::from("{Jack L. Weinbender}")}, input);
}
